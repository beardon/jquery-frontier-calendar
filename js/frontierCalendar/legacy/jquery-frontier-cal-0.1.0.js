...
(function($) {
	 ...
	 *
	 * @param startDate - (Date) - The date the agenda item starts. This will get added to the hashtable under key "startDate".
	 * @param endDate   - (Date) - The date the agenda item ends. This will get added to the hashtable under key "endDate".
	 * @param hashData  - (Hashtable from jshashtable.js) - A Hashtable that contains all data for the agenda item.
	 */	
	function CalendarAgendaItem(startDate,endDate,hashData) {
		...
		// put end and start dates into the hashtable
		this.agendaData.put("startDate",this.startDt);
		this.agendaData.put("endDate",this.endDt);
	...
	var jFrontierCalPlugin = function(calElm,dayClickCallback){
		 ...
		 */
		this.addAgendaItem = function(calId,startDate,endDate,data){
			if(calId != null && startDate != null && endDate != null){
				...
				var agi = new CalendarAgendaItem(startDate,endDate,hashData);
