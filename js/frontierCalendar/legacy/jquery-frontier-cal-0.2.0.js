	...
	function Calendar() {
		...
		*/
		...
		this.renderAgendaDivElement = function(
			agi,startDayObject,endDayObject,leftEnd,rightEnd){
			...
			var startDt = startDayObject.getDate();
			var displayMessage = "("+agi.getStartDate().getHours()+":"+agi.getStartDate().getMinutes()+")" + title;
