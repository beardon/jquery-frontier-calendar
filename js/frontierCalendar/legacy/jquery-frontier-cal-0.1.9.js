		...
		*/
		...
		this.renderSingleAgendaItem = function(agi){
			...
			if((this.daysDifference(firstRenderDate,lastRenderDate) + firstDtIndex) > 6){
				...
				var lastDaySameWeekDate = this.getLastDayInSameWeek(firstRenderDate);
				...
				while(this.daysDifferenceDirection(lastRenderDate,lastDaySameWeekDate) < 0){
					var firstDayNextWeekDate = this.getFirstDayNextWeek(lastDaySameWeekDate);	
					lastDaySameWeekDate = this.getLastDayInSameWeek(firstDayNextWeekDate);
					if(this.daysDifferenceDirection(lastRenderDate,lastDaySameWeekDate) < 0){
